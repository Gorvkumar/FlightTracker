...
export const Home = () => {
  ...
  const handleCheckStatus = () => {
      ...
      navigate(`/flightboard`); // Corrected path to '/flightboard'
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                <span className="block">Track Your Flight</span>
                <span className="block text-blue-200">In Real Time</span>
              </h1>
              <p className="mt-3 text-base text-blue-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                Get instant updates on flight status, delays, and gate changes. Stay informed with our real-time flight tracking system.
              </p>
